...
if __name__ == "__main__" :
    ...
    while flag == "start" :
        ...
        try:
            ...
            key=["up", "down", "right", "tab" ,"left","next","search","stop","start","enter","undo","redo","copy","paste","back","okey","quit","open","insert", "add","select","ok","hello", "hai", "hey","hi", "hay"]
                ...
                if i in key:
                    ...
                    # right arrow key command
                        ...
                        if i=="next":
                            if "line" in command:
                                keyboard.press_and_release('enter') 
                                reply.engine.say("adding new line")
                                reply.engine.runAndWait()
                    ...
                    # search web
                        ...
                        for query in tokens[1:]:
                            link = link + "+" + query
                        print ("link",link)
                        #link = search(search_query, tld="co.in", num=1, stop=1, pause=2)
                        #for link in search(search_query, tld="co.in", num=1, stop=1, pause=2): 
                            #print (link)
                        ...
                        print (links)
                        print ("\n link extraccted",links[0])
                        webbrowser.open(links[0][0])"""
                        
                    # paste command ctrl + v                  
                    elif i=="paste":
                        reply.engine.say("pasting text")
                        reply.engine.runAndWait()
